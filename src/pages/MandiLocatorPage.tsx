    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          {/* Link to Enhanced Map Version */}
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-medium text-blue-900">🗺️ Try our Enhanced Map Version</h3>
                <p className="text-blue-700 text-sm">
                  Experience interactive maps with Azure Maps integration, route optimization, and real-time directions.
                </p>
              </div>
              <a 
                href="/agro-mandi-locator" 
